                      ...
                      <div class="form-check">
                          ...
                          <div class="radio">
                              <label for="USUARIO_SEXO" class="form-check-label ">
                                  <input type="radio" id="Masculino" name="USUARIO_SEXO" value="{{$usuario->USUARIO_SEXO}}" class="form-check-input" >{{'Masculino'}}
                              </label>
                          </div>

                          <div class="radio">
                              <label for="USUARIO_SEXO" class="form-check-label ">
                                  <input type="radio" id="Femenino" name="USUARIO_SEXO" value="{{$usuario->USUARIO_SEXO}}" class="form-check-input">{{'Femenino'}}
                              </label>
                          </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input  class="form-control" name="USUARIO_CORREO" id="USUARIO_CORREO" type="email" value="{{$usuario->USUARIO_CORREO}}" placeholder="Ingrese su correo electronico"  data-validation-required-message="Porfavor ingrese un correo valido">
                    </div>
                </div>
            </div>
                            ...
                            <div class="form-check">
                                ...
                                <div class="radio">
                                    <label for="USUARIO_ESTADO_CIVIL" class="form-check-label ">
                                        <input type="radio" id="solter@" name="USUARIO_ESTADO_CIVIL" value="{{$usuario->USUARIO_ESTADO_CIVIL}}" class="form-check-input">{{'Solter@'}}
                                    </label>
                                </div>

                                <div class="radio">
                                    <label for="USUARIO_ESTADO_CIVIL" class="form-check-label ">
                                        <input type="radio" id="casad@" name="USUARIO_ESTADO_CIVIL" value="{{$usuario->USUARIO_ESTADO_CIVIL}}" class="form-check-input">{{'Casad@'}}
                                    </label>
                                </div>
